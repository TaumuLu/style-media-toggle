(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function deleteRules(styleRule) {
        return Array.from(styleRule.cssRules, function (rule, i) {
    ...
    var MediaToggle = /** @class */ (function () {
        function MediaToggle(options) {
            var _this = this;
            this.options = {};
            this.cssMediaRules = new Set();
            this.cssTexts = [];
            this.toggle = function (flag) {
                if (flag === void 0) { flag = !_this.disabled; }
                if (flag) {
                    _this.cssTexts = __spread(_this.cssMediaRules).reduce(function (p, c) {
